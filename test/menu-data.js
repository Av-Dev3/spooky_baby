// Full menu data - single source of truth for test page demos
const MENU_DATA = {
  cupcakes: {
    icon: '🧁',
    title: 'Cupcakes',
    sublines: [
      {
        ...
        items: [
          { icon: '🍋', name: 'Lemon Burst', desc: 'Bright, buttery lemon cake with fresh zest and smooth lemon buttercream', pricing: '6-Pack: $20 · Dozen: $35' },
